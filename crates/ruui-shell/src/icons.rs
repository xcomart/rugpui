...
//! static SET: IconSet = IconSet::new(&[ruui_shell::WINDOW_CONTROL_ICONS, ICONS]);
//! ```
...
/// (`GLYPH_SIZE` in [`ruui::window_controls`]), which is half the viewBox, so
...
/// The four caption glyphs as [`ruui::WindowControlIcons`], which is the shape
/// [`crate::window_control_strips`] wants them in.
pub fn window_control_icons() -> ruui::WindowControlIcons {
    ruui::WindowControlIcons {
