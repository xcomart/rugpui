...
/// no background at all: it asks [`rugpui::window_translucent`] and skips it,
...
/// [`rugpui::set_window_tint`] at start-up and on a settings *save*. Which means
