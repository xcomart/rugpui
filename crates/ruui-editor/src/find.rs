...
//! template is a field name or a statement name, and a regex engine here would
//! be 1.5MB of DFA machinery for a feature nothing else in this crate wants.
//! If a pattern language is ever wanted it goes in as an option beside this,
//! not instead of it.
//!
